const page = GenerationPage.create({
    ...
    fields: [
        ...
        { element: "guidance_scale", key: "guidance_scale", type: "number", fallback: 0.0 },
...
async function generateZImageInpaint() {
    ...
    try {
        ...
        await page.run(inputs, "Failed to run Z-Image inpaint job:");
    } catch (error) {
        console.warn("Failed to upload Z-Image inpaint inputs:", error);
    }
}
