...
function collectQwenImagePresetSettings() {
    return {
...
async function applyQwenImagePresetSettings(settings) {
...
window.PresetPanel?.init({
    ...
    collectSettings: collectQwenImagePresetSettings,
    applySettings: applyQwenImagePresetSettings,
});
