...
function collectQwenImageInpaintPresetSettings() {
    return {
...
async function applyQwenImageInpaintPresetSettings(settings) {
...
window.PresetPanel?.init({
    ...
    collectSettings: collectQwenImageInpaintPresetSettings,
    applySettings: applyQwenImageInpaintPresetSettings,
});
...
window.generateQwenImageInpaint = generateQwenImageInpaint;
