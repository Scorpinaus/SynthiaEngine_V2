"""Run a simple img2img inference with the local SD1.5 modular repo."""
...
DEFAULT_OUTPUT_PATH = SCRIPT_DIR / "outputs" / "sd15_modular_img2img.png"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run SD1.5 Modular Diffusers img2img inference.")
    parser.add_argument("--image", type=Path, required=True, help="Path to the input image.")
    parser.add_argument("--prompt", default="turn this into a moody oil painting", help="Positive prompt text.")
