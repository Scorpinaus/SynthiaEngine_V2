"""Run a simple text-to-image inference with the local SDXL modular repo."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Path to the local modular SDXL repo.",
    )
    parser.add_argument(
        "--model",
        default="stabilityai/stable-diffusion-xl-base-1.0",
        help="Model repo used for loading tokenizer, encoders, unet, vae, and scheduler.",
    )
    return parser
