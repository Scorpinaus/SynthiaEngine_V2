"""Run ControlNet img2img inference with Diffusers' SDXL modular pipeline."""
...
DEFAULT_OUTPUT_PATH = SCRIPT_DIR / "outputs" / "sdxl_modular_controlnet_img2img.png"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run SDXL Modular Diffusers ControlNet img2img inference.")
