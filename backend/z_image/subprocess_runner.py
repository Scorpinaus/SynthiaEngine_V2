...
def main(argv: list[str] | None = None) -> int:
    ...
    if len(args) != 2:
        print("Usage: python -m backend.z_image.subprocess_runner <input-json> <output-json>", file=sys.stderr)
        return 2
    ...
    try:
        ...
        if operation not in dispatch:
            raise ValueError(f"Unsupported Z-Image subprocess operation: {operation}")
        ...
        try:
            ...
            print("Z-Image subprocess cleanup failed:", file=sys.stderr)
